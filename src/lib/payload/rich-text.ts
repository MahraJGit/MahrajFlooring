 ...
 */
function collectHeadings(content: Post["content"]) {
...
export function extractHeadings(content: Post["content"]): ArticleHeading[] {
...
export function buildHeadingIds(content: Post["content"]) {
