  ...
  sections: [
    {
      ...
      paragraphs: [
        ...
        "We may update these Terms from time to time. The “Last updated” date at the top of this page will change when we do. Continued use of the website after an update constitutes acceptance of the revised Terms.",
      ],
    },
    {
      id: "services",
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Warranties do not cover damage from misuse, incorrect cleaning chemicals, unauthorised repairs, movement of the building, or failure to follow the maintenance guide provided at handover.",
      ],
    },
    {
      id: "website",
      ...
      paragraphs: [
        ...
        "All trademarks, photography, drawings, and written content on this website remain the property of Mahraj Flooring or our licensors. You may share pages for legitimate project communication but may not reproduce catalogues commercially without written consent.",
      ],
    },
    {
      id: "liability",
      ...
      paragraphs: [
        ...
        "To the fullest extent permitted by applicable law, our liability for any claim arising from website use is limited to the amount you paid us (if any) for the relevant service. Nothing in these Terms excludes liability that cannot be excluded under UAE law, including liability for fraud or personal injury caused by negligence.",
      ],
    },
    {
      id: "third-parties",
      ...
      paragraphs: [
        "The website may link to maps, social platforms, or manufacturer resources. Those sites have their own terms. We are not responsible for their content or availability.",
        "We may involve authorised partners, logistics providers, or specialist installers to deliver a project. They remain bound by confidentiality and quality requirements we set for the engagement.",
      ],
    },
    {
      id: "law",
    ...
    },
    {
      ...
      paragraphs: [
        "If you need clarification before placing an order, contact our commercial team. Written project documents always take priority for live installations.",
      ],
    },
  ],
};
  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        ...
        "Technical data: IP address, browser type, device, and pages visited (via cookies or similar tools)",
    ...
    },
    {
      ...
      bullets: [
        ...
        "Sending requested catalogues or insight emails (you can unsubscribe at any time)",
    ...
    },
    {
      ...
      paragraphs: [
        "We use reasonable organisational and technical measures to protect personal data against unauthorised access, loss, or misuse. No internet transmission is completely secure; please avoid sending sensitive payment details through unsolicited email.",
      ],
    },
    {
      id: "rights",
      ...
      paragraphs: [
        "Subject to applicable law, you may ask us to access, correct, or delete personal data we hold about you, or to stop using it for marketing. If you subscribed to insights, use the unsubscribe link in the email or contact us directly.",
        "We may need to verify your identity before fulfilling a request, and we may retain limited records where we have a legal obligation to do so.",
      ],
    },
    {
      id: "international",
    ...
    },
    {
      ...
      title: "Children",
      paragraphs: [
        "This website is intended for commercial clients, consultants, and contractors. We do not knowingly collect personal data from children.",
      ],
    },
    {
      id: "updates",
    ...
    },
    {
      ...
      paragraphs: [
        "For questions or requests relating to personal data, email info@mahrajfloors.com or write to Mahraj Flooring, Industrial Area 4, Al Qusais, Dubai, UAE.",
      ],
    },
  ],
};
